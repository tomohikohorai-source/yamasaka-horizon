...
export const siteContent = {
  ...
  news: [
    ...
    },
    {
      ...
      content: '2025年7月7日（月）、大阪産業創造館にて開催された「新たな応援のカタチ！スポーツxビジネスで共創を巻き起こそう」に代表取締役社長の洞井知彦がファシリテーターとして登壇しました。\n\n当日は、第一部にて株式会社RIGHTHAND 代表取締役CEOの菅原 右教氏と株式会社Rtv 代表取締役の須澤 壮太氏を迎え、スポーツビジネスに関する様々なテーマのトークセッションを行いました。\nその後の第二部交流パートでは、「パートナー探し」「ビジネスのヒント・きっかけ探し」「情報交換」の場として、事業者同士で「スポーツxビジネス」について考え連携することで大いに盛り上がりました。'
    },
    {
      id: 'news-007',
      date: '2025.05.27',
