...
export const siteContent = {
  ...
  news: [
    ...
    },
    {
      ...
      date: '2026.03.11',
      category: 'EVENT',
      title: '4月27日（月）「スポーツ×ビジネスの可能性！「感動」「勝利」「熱狂」が生む新たな共創スタイル」にて代表取締役社長の洞井がファシリテーターを務めます',
      type: 'Announcement',
      image: `${GOOGLE_DRIVE_BASE}1gy_JfJ2KXKDGbitvrw_AkSsvSXRStXw9`,
      content: '2026年4月27日（月）、大阪産業創造館4階 イベントホールにて開催される「スポーツ×ビジネスの可能性！「感動」「勝利」「熱狂」が生む新たな共創スタイル」に代表取締役社長の洞井知彦がファシリテーターとして登壇します。\n※写真は昨年度のイベントの様子です。\n\n本イベントでは、13:30〜の第一部にてスポーツビジネスの第一線で活躍する方々をお招きし、トークセッションでリアルな視点を紹介。\nその後の第二部交流パートでは、トークセッションの登壇者も交え、「パートナー探し」「ビジネスのヒント・きっかけ探し」「情報交換」の場として、事業者同士で「スポーツxビジネス」について考え連携する場としてご活用いただけます。\n\n詳細および参加の申込は下記ページよりご確認ください。\nhttps://www.sansokan.jp/events/eve_detail.san?H_A_NO=47113'
    },
    {
      id: 'news-012',
      date: '2026.02.03',
